...
namespace Community.CsharpSqlite
{
    ...
    public partial class Sqlite3
    {
        ...
        */
#if SQLITE_DEBUG
        private static bool sqlite3VdbeAddopTrace = false;
#endif
...
if( 0==isPrepareV2 ) return;
    ...
    */
        ...
        private static void sqlite3VdbeTrace(Vdbe p, FILE trace)
        {
            p.trace = trace;
        }
...
pOp.cnt = 0;
        ...
        */
        ...
        //P4_INT32
        private static int sqlite3VdbeAddOp4(Vdbe p, int op, int p1, int p2, int p3, i32 pP4, int p4type)
        {
        ...
        //P4_INT64
        private static int sqlite3VdbeAddOp4(Vdbe p, int op, int p1, int p2, int p3, i64 pP4, int p4type)
        {
            union_p4 _p4 = new union_p4();
            _p4.pI64 = pP4;
            int addr = sqlite3VdbeAddOp3(p, op, p1, p2, p3);
 ...
 || ((opcode == OP_Halt || opcode == OP_HaltIfNull)
    ...
    */
        ...
        */
        ...
        private static VdbeOp[] sqlite3VdbeTakeOpArray(Vdbe p, ref int pnOp, ref int pnMaxArg)
        {
            VdbeOp[] aOp = p.aOp;
        ...
        */
        ...
        private static void sqlite3VdbeChangeP5(Vdbe p, u8 val)
        {
            Debug.Assert(p != null);
            if (p.aOp != null)
            {
    ...
    */
        ...
        private static void sqlite3VdbeComment(Vdbe p, string zFormat, params object[] ap)
        {
            if (null == p)
                return;
            //      va_list ap;
        ...
        private static void sqlite3VdbeNoopComment(Vdbe p, string zFormat, params object[] ap)
        {
            if (null == p)
                return;
            //va_list ap;
    ...
    */
        private const VdbeOp dummy = null;  /* Ignore the MSVC warning about no initializer */
...
void sqlite3VdbeLeave(Vdbe *p){
  ...
  for(i=0, mask=1; i<nDb; i++, mask += mask){
    ...
    */
        ...
        private static void sqlite3VdbePrintOp(FILE pOut, int pc, Op pOp)
        {
            string zP4;
            string zPtr = null;
...
""
    ...
    */
        ...
        private static int sqlite3VdbeList(
        Vdbe p                   /* The VDBE */
        )
        {
    ...
    */
      ...
      for(i=0; i<p.nOp; i++){
        ...
        */
        ...
        private static void sqlite3VdbeMakeReady(
        Vdbe p,                        /* The VDBE */
...
fclose(out);
        ...
        */
        ...
        private static int sqlite3VdbeFinalize(ref Vdbe p)
        {
            int rc = SQLITE_OK;
        ...
        */
        ...
        private static void sqlite3VdbeDeleteObject(sqlite3 db, ref Vdbe p)
        {
        ...
        */
        ...
        private static void sqlite3VdbeDelete(ref Vdbe p)
        {
            sqlite3 db;
            if (NEVER(p == null))
                return;
        ...
        */
        ...
        private static u32 sqlite3VdbeSerialType(Mem pMem, int file_format)
        {
        ...
        */
        private static u32[] aSize = new u32[] { 0, 1, 2, 3, 4, 6, 8, 8, 0, 0, 0, 0 };

        private static u32 sqlite3VdbeSerialTypeLen(u32 serial_type)
        {
            if (serial_type >= 12)
            {
...
//# define swapMixedEndianFloat(X)  X = floatSwap(X)
    ...
    */
        ...
        private static u32 sqlite3VdbeSerialPut(byte[] buf, int offset, int nBuf, Mem pMem, int file_format)
        {
...
swapMixedEndianFloat( v );
        ...
        */
        ...
        private static u32 sqlite3VdbeSerialGet(
...
swapMixedEndianFloat(x);
        ...
        private static int sqlite3VdbeSerialGet(
        byte[] buf,     /* Buffer to deserialize from */
        u32 serial_type,              /* Serial type to deserialize */
        Mem pMem                     /* Memory cell to write value into */
        )
...
swapMixedEndianFloat(x);
        ...
        */
        ...
        private static UnpackedRecord sqlite3VdbeRecordUnpack(
        ...
        */
        ...
        private static Mem mem1 = new Mem();
        ...
        */
        ...
        private static int sqlite3VdbeIdxRowid(sqlite3 db, BtCursor pCur, ref i64 rowid)
        {
            i64 nCellKey = 0;
            int rc;
        ...
        */
        ...
        private static sqlite3_value sqlite3VdbeGetValue(Vdbe v, int iVar, u8 aff)
        {
            Debug.Assert(iVar > 0);
            if (v != null)
            {
