...
namespace Community.CsharpSqlite
{
    ...
    public partial class Sqlite3
    {
        ...
        */
        ...
        private static bool sqlite3WhereTrace = false;
#endif
...
#endif
        private const int TERM_DYNAMIC = 0x01; /* Need to call sqlite3ExprDelete(db, ref pExpr) */
        private const int TERM_VIRTUAL = 0x02; /* Added by the optimizer.  Do not code */
        private const int TERM_CODED = 0x04; /* This term is already coded */
        private const int TERM_COPIED = 0x08; /* Has a child */
        private const int TERM_ORINFO = 0x10; /* Need to free the WhereTerm.u.pOrInfo object */
        private const int TERM_ANDINFO = 0x20; /* Need to free the WhereTerm.u.pAndInfo obj */
        private const int TERM_OR_OK = 0x40; /* Used during OR-clause processing */
#if SQLITE_ENABLE_STAT2
    const int TERM_VNULL = 0x80;  /* Manufactured x>NULL or x<=NULL term */
#else
        private const int TERM_VNULL = 0x00;  /* Disabled if not using stat2 */
#endif
...
public WhereTerm[] aStatic = new WhereTerm[1];    /* Initial static space for a[] */
        ...
        */
        ...
        private const int WO_IN = 0x001;

        private const int WO_EQ = 0x002;
        private const int WO_LT = (WO_EQ << (TK_LT - TK_EQ));
        private const int WO_LE = (WO_EQ << (TK_LE - TK_EQ));
        private const int WO_GT = (WO_EQ << (TK_GT - TK_EQ));
        private const int WO_GE = (WO_EQ << (TK_GE - TK_EQ));
        private const int WO_MATCH = 0x040;
        private const int WO_ISNULL = 0x080;
        private const int WO_OR = 0x100;       /* Two or more OR-connected terms */
        private const int WO_AND = 0x200;      /* Two or more AND-connected terms */
        private const int WO_NOOP = 0x800;     /* This term does not restrict search space */

        private const int WO_ALL = 0xfff;       /* Mask of all possible WO_* values */
        private const int WO_SINGLE = 0x0ff;       /* Mask of all non-compound WO_* values */
                                                   /*
        ...
        private const int WHERE_ROWID_EQ = 0x00001000;

        private const int WHERE_ROWID_RANGE = 0x00002000;
        private const int WHERE_COLUMN_EQ = 0x00010000;
        private const int WHERE_COLUMN_RANGE = 0x00020000;
        private const int WHERE_COLUMN_IN = 0x00040000;
        private const int WHERE_COLUMN_NULL = 0x00080000;
        private const int WHERE_INDEXED = 0x000f0000;
        private const int WHERE_IN_ABLE = 0x000f1000;
        private const int WHERE_NOT_FULLSCAN = 0x100f3000;
        private const int WHERE_TOP_LIMIT = 0x00100000;
        private const int WHERE_BTM_LIMIT = 0x00200000;
        private const int WHERE_BOTH_LIMIT = 0x00300000;
        private const int WHERE_IDX_ONLY = 0x00800000;
        private const int WHERE_ORDERBY = 0x01000000;
        private const int WHERE_REVERSE = 0x02000000;
        private const int WHERE_UNIQUE = 0x04000000;
        private const int WHERE_VIRTUALTABLE = 0x08000000;
        private const int WHERE_MULTI_OR = 0x10000000;
        private const int WHERE_TEMP_INDEX = 0x20000000;
        ...
        */
        ...
        private static int whereClauseInsert(WhereClause pWC, Expr p, u8 wtFlags)
        {
            WhereTerm pTerm;
            int idx;
        ...
        */
        ...
        private static Bitmask getMask(WhereMaskSet pMaskSet, int iCursor)
        {
            int i;
        ...
        */
        ...
        private static Bitmask exprTableUsage(WhereMaskSet pMaskSet, Expr p)
        {
            Bitmask mask = 0;
            if (p == null)
                return 0;
        ...
        private static Bitmask exprListTableUsage(WhereMaskSet pMaskSet, ExprList pList)
        {
            int i;
            Bitmask mask = 0;
            if (pList != null)
        ...
        private static Bitmask exprSelectTableUsage(WhereMaskSet pMaskSet, Select pS)
        {
            Bitmask mask = 0;
            while (pS != null)
            {
        ...
        */
        ...
        private static u16 operatorMask(int op)
        {
            u16 c;
        ...
        */
        ...
        private static WhereTerm findTerm(
        ...
        */
        ...
        private static void exprAnalyzeAll(
    ...
    */
        ...
        */
        ...
        private static int isMatchOfColumn(
        Expr pExpr      /* Test this expression */
        )
        {
            ExprList pList;
    ...
    */
        ...
        private static void exprAnalyze(
        SrcList pSrc,            /* the FROM clause */
...
WhereCost pCost            /* Lowest cost query plan */
    ...
    */
        ...
        private static sqlite3_index_info allocateIndexInfo(
        Parse pParse,
        WhereClause pWC,
        SrcList_item pSrc,
        ExprList pOrderBy
      ...
      ** to this virtual table */
      ...
      WHERETRACE( "xBestIndex for %s\n", pTab.zName );
        ...
        */
        ...
        private static void bestVirtualIndex(
        Parse pParse,                  /* The parsing context */
        WhereClause pWC,               /* The WHERE clause */
        SrcList_item pSrc,             /* The FROM clause term to search */
...
static void explainOneScan(  Parse u,  SrcList v,  WhereLevel w,  int x,  int y,  u16 z){}
    ...
    */
        ...
        private static Bitmask codeOneLoopStart(
...
*/
    ...
    */
        ...
        */
        ...
        private static WhereInfo sqlite3WhereBegin(
