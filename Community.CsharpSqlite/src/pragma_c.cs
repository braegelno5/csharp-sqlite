...
namespace Community.CsharpSqlite
{
    ...
    */
        ...
        private static u8 getSafetyLevel(string z)
        {
            //                             /* 123456789 123456789 */
        ...
        */
        ...
        private static u8 sqlite3GetBoolean(string z)
        {
    ...
    */
        ...
        private static u8 getAutoVacuum(string z)
        {
            int i;
    ...
    */
        ...
        private static void returnSingleInt(Parse pParse, string zLabel, i64 value)
        {
...
, "wal"
        ...
        */
        ...
        private static EncName[] encnames = new EncName[]  {
