...
break;
        ...
        */
        ...
        private static compareInfo globInfo = new compareInfo('*', '?', '[', false);
        /* The correct SQL-92 behavior is for the LIKE operator to ignore
        ** case.  Thus  'a' LIKE 'A' would be true. */
        private static compareInfo likeInfoNorm = new compareInfo('%', '_', '\0', true);
        /* If SQLITE_CASE_SENSITIVE_LIKE is defined, then the LIKE operator
        ** is case sensitive causing 'a' LIKE 'A' to be false */
        private static compareInfo likeInfoAlt = new compareInfo('%', '_', '\0', false);
    ...
    */
        ...
        */
        ...
        private static void errlogFunc(
        sqlite3_context context,
        int argc,
        sqlite3_value[] argv
        )
