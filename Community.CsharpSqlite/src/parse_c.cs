...
namespace Community.CsharpSqlite
{
    ...
    public partial class Sqlite3
    {
        ...
        */
        ...
        private static void yytestcase<T>(T X)
        {
            testcase(X);
        }
    ...
    */
        ...
        ** YYMINORTYPE objects to zero. */
        private YYMINORTYPE yyzerominor = new YYMINORTYPE();//static const YYMINORTYPE yyzerominor = { 0 };
        ...
        */
        ...
        private static YYACTIONTYPE[] yy_action = new YYACTIONTYPE[]{
...
/*  1550 */   961,  961,  961,  961,  961,  961,  370,
        ...
        private static YYCODETYPE[] yy_lookahead = new YYCODETYPE[]{
...
/*  1550 */   252,  252,  252,  252,  252,  252,  236,
        ...
        private const int YY_SHIFT_USE_DFLT = -74;//#define YY_SHIFT_USE_DFLT (-74)
        private const int YY_SHIFT_COUNT = 418;   //#define YY_SHIFT_COUNT (418)
        private const int YY_SHIFT_MIN = -73;     //#define YY_SHIFT_MIN   (-73)
        private const int YY_SHIFT_MAX = 1468;    //#define YY_SHIFT_MAX   (1468)

        private static short[] yy_shift_ofst = new short[]{
...
/*   410 */   240,  224,  143,   62,   18,   71,   39,    9,    5,
        ...
        private const int YY_REDUCE_USE_DFLT = -142;  //#define YY_REDUCE_USE_DFLT (-142)
        private const int YY_REDUCE_COUNT = 312;      //#define YY_REDUCE_COUNT (312)
        private const int YY_REDUCE_MIN = -141;       //#define YY_REDUCE_MIN   (-141)
        private const int YY_REDUCE_MAX = 1369;       //#define YY_REDUCE_MAX   (1369)

        private static short[] yy_reduce_ofst = new short[]{
...
/*   310 */  1031, 1023, 1030,
        ...
        private static YYACTIONTYPE[] yy_default = new YYACTIONTYPE[] {
...
/*   620 */   672,  671,  669,  668,  642,  639,  638,  634,  633,  631,
        ...
        */
        ...
        private static YYCODETYPE[] yyFallback = new YYCODETYPE[]{
0,  /*          $ => nothing */
0,  /*       SEMI => nothing */
26,  /*    EXPLAIN => ID */
26,  /*      QUERY => ID */
...
public yyStackEntry *yystack;        /* The parser's stack */
        ...
        //#include <stdio.h>
        private static TextWriter yyTraceFILE = null;

        private static string yyTracePrompt = "";
#endif // * NDEBUG */
    ...
    */
        ...
        private static void sqlite3ParserTrace(TextWriter TraceFILE, string zTracePrompt)
        {
    ...
    ** are required.  The following table supplies these names */
        ...
        private static string[] yyTokenName = {
"$",             "SEMI",          "EXPLAIN",       "QUERY",
...
"vtabarg",       "vtabargtoken",  "lp",            "anylist",
    ...
    */
        ...
        private static string[] yyRuleName = {
/*   0 */ "input ::= cmdlist",
...
yyGrowStack(pParser);
        ...
        */
        ...
        private static void sqlite3ParserFree(
...
return pParser.yyidxMax;
    ...
    */
        ...
        private static int yy_find_shift_action(
...
return;
        ...
        */
        ...
        private static _yyRuleInfo[] yyRuleInfo = new _yyRuleInfo[]{
...
yymsp[0].minor = yygotominor;
        ...
        */
        ...
        private static void yy_parse_failed(
        yyParser yypParser           /* The parser */
        )
        {
            Parse pParse = yypParser.pParse; //       sqlite3ParserARG_FETCH;
