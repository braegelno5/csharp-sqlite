...
namespace Community.CsharpSqlite
{
    ...
    public partial class Sqlite3
    {
        ...
        */
        ...
        private static int getDigits(string zDate, int N0, int min0, int max0, char nextC0, ref int pVal0, int N1, int min1, int max1, char nextC1, ref int pVal1)
        {
        ...
        private static int getDigits(string zDate, int N0, int min0, int max0, char nextC0, ref int pVal0, int N1, int min1, int max1, char nextC1, ref int pVal1, int N2, int min2, int max2, char nextC2, ref int pVal2)
        {
            int c0 = getDigits(zDate + '\0', N0, min0, max0, nextC0, ref pVal0);
            if (c0 == 0)
                return 0;
        ...
        private static int getDigits(string zDate, int N, int min, int max, char nextC, ref int pVal)
        {
            //va_list ap;
            int val;
            //int N;
  ...
  rc = localtime_s(pTm, t);
    ...
    */
        ...
        */
        ...
        private static void datetimeFunc(
        sqlite3_context context,
        int argc,
        sqlite3_value[] argv
        )
