...
return nRet;
        ...
        */
        ...
        private static Mem0Global mem0 = new Mem0Global();
...
return sqlite3MemoryAlarm(xCallback, pArg, iThreshold);
    ...
    */
        ...
        private static sqlite3_int64 sqlite3_soft_heap_limit64(sqlite3_int64 n)
        {
        ...
        */
        ...
        private static sqlite3_int64 sqlite3_memory_used()
        {
            int n = 0, mx = 0;
            sqlite3_int64 res;
        ...
        */
        ...
        private static sqlite3_int64 sqlite3_memory_highwater(int resetFlag)
        {
            int n = 0, mx = 0;
            sqlite3_int64 res;
...
p = sqlite3GlobalConfig.m.xMalloc(nFull);
        ...
        */
        ...
        private static int[] sqlite3Malloc(int[] pInt, u32 n)
        {
        ...
        private static byte[] sqlite3Malloc(u32 n)
        {
        ...
        */
        ...
        private static int scratchAllocOut = 0;
#endif
...
return p && p>=db.lookaside.pStart && p<db.lookaside.pEnd;
    ...
    */
        ...
        private static int sqlite3MallocSize(int[] p)
        {
            return p.Length;
        }
        ...
        */
        ...
        private static void sqlite3DbFree(sqlite3 db, ref byte[] p)
        {
            Debug.Assert(db == null || sqlite3_mutex_held(db.mutex));
            if (db != null)
            {
